...
if ( ! class_exists( 'Kirki_Init' ) ) {
	...
	class Kirki_Init {
		...
		public function set_url() {
			...
			$path = wp_normalize_path( get_parent_theme_file_path( Kirki::$path ) );
			...
			Kirki::$url = plugin_dir_url( get_parent_theme_file_path( '/core/customizer/kirki/includes/' ) . 'kirki.php' );
